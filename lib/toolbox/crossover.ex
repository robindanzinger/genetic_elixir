defmodule Toolbox.Crossover do
  ...
  @spec uniform(Chromosome.t, Chromosome.t) :: {Chromosome.t, Chromosome.t}
  def uniform(p1, p2), do: uniform(p1, p2, 0.5)
  ...
  @spec whole_arithmetic_crossover(Chromosome.t, Chromosome.t, float) :: {Chromosome.t, Chromosome.t}
